 ...
 */
class Version20180422111018 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE person ADD full_name VARCHAR(255) DEFAULT NULL, CHANGE manager_id manager_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE objective_management CHANGE vp_weight vp_weight DOUBLE PRECISION DEFAULT \'NULL\', CHANGE ceo_weight ceo_weight DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE person DROP full_name, CHANGE manager_id manager_id INT DEFAULT NULL');
    }
}

 ...
 */
class Version20180422150727 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE manager_id manager_id INT DEFAULT NULL, CHANGE full_name full_name VARCHAR(255) DEFAULT NULL, CHANGE ldap_name ldap_name VARCHAR(64) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE objective_management CHANGE vp_weight vp_weight DOUBLE PRECISION DEFAULT \'NULL\', CHANGE ceo_weight ceo_weight DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE person CHANGE manager_id manager_id INT DEFAULT NULL, CHANGE full_name full_name VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE ldap_name ldap_name VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
